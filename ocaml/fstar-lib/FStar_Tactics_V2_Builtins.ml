...
let norm_binding_type       = fun s ->   from_tac_2 B.norm_binding_type s
...
type ('env, 'sc, 't, 'pats) match_complete_token = unit
...
let check_match_complete         = from_tac_4 B.refl_check_match_complete
