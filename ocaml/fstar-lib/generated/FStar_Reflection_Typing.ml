    ...
    fun t ->
      fun v0 ->
        fun v1 ->
          ...
          h2
let (t_true : FStar_Reflection_Types.term) =
  FStar_Reflection_V2_Builtins.pack_ln
    (FStar_Reflection_V2_Data.Tv_FVar
       (FStar_Reflection_V2_Builtins.pack_fv ["Prims"; "l_True"]))
let (t_false : FStar_Reflection_Types.term) =
  FStar_Reflection_V2_Builtins.pack_ln
    (FStar_Reflection_V2_Data.Tv_FVar
       (FStar_Reflection_V2_Builtins.pack_fv ["Prims"; "l_False"]))
...
type ('g, 'bs) all_fresh_bindings = Obj.t
  ...
  fun bs ->
    fun t ->
      close_term_vs (FStar_List_Tot_Base.map FStar_Pervasives_Native.fst bs)
        t
type 'p atomic_pat = Obj.t
type ('uuuuu, 'f, 'l) for_allP = Obj.t
type 'p simple_pat = Obj.t
...
and ('g, 'sc, 'scuty, 'rty, 'dummyV0) branches_typing =
  | BT_Nil 
  | BT_S of FStar_Reflection_V2_Data.branch * (unit, unit, unit, unit, 
  unit) branch_ok * FStar_Reflection_V2_Data.branch Prims.list * (unit, 
  unit, unit, unit, unit) branches_typing 
and ('dummyV0, 'dummyV1, 'dummyV2, 'dummyV3, 'dummyV4) branch_ok =
  | BO_Cons of FStar_Reflection_Types.env * FStar_Reflection_Types.term *
  FStar_Reflection_Types.typ * comp_typ * FStar_Reflection_Types.fv *
  bindings * FStar_Reflection_V2_Data.var * FStar_Reflection_Types.term *
  (unit, unit, unit) typing 
  | BO_Var of FStar_Reflection_Types.env * FStar_Reflection_Types.term *
  FStar_Reflection_Types.typ * comp_typ * FStar_Reflection_V2_Data.var *
  FStar_Reflection_V2_Data.var * FStar_Reflection_Types.term * (unit, 
  unit, unit) typing 
  | BO_Const of FStar_Reflection_Types.env * FStar_Reflection_Types.term *
  FStar_Reflection_Types.typ * comp_typ * FStar_Reflection_V2_Data.vconst *
  FStar_Reflection_V2_Data.var * FStar_Reflection_Types.term * (unit, 
  unit, unit) typing 
and ('dummyV0, 'dummyV1, 'dummyV2, 'dummyV3) match_is_complete =
  ...
  (unit, unit, unit, unit) FStar_Tactics_V2_Builtins.match_complete_token 
...
let uu___is_BT_Nil uu___4 uu___3 uu___2 uu___1 uu___ uu___5 =
  match uu___5 with | BT_Nil _ -> true | _ -> false
let uu___is_BT_S uu___4 uu___3 uu___2 uu___1 uu___ uu___5 =
  match uu___5 with | BT_S _ -> true | _ -> false
let uu___is_BO_Cons uu___4 uu___3 uu___2 uu___1 uu___ uu___5 =
  match uu___5 with | BO_Cons _ -> true | _ -> false
let uu___is_BO_Var uu___4 uu___3 uu___2 uu___1 uu___ uu___5 =
  match uu___5 with | BO_Var _ -> true | _ -> false
let uu___is_BO_Const uu___4 uu___3 uu___2 uu___1 uu___ uu___5 =
  match uu___5 with | BO_Const _ -> true | _ -> false
let uu___is_MC_Tok uu___3 uu___2 uu___1 uu___ uu___4 =
  match uu___4 with | MC_Tok _ -> true | _ -> false
                                ...
                                (((FStar_Reflection_V2_Data.Pat_Constant
                                  ...
                                  (BO_Const
                                     (g, scrutinee, bool_ty, (eff, ty),
                                       FStar_Reflection_V2_Data.C_True, hyp,
                                       then_, tt)),
                                  [((FStar_Reflection_V2_Data.Pat_Constant
