...
let () =
    ...
    [ unseal_step;
      ...
      mk_tac_step_4 0 "check_match_complete"
        refl_check_match_complete RE.e_env RE.e_term RE.e_term (e_list RE.e_pattern) (e_option e_unit)
        refl_check_match_complete NRE.e_env NRE.e_term NRE.e_term (NBET.e_list NRE.e_pattern) (NBET.e_option NBET.e_unit);
